 ...
 */
class LoginUsecaseWithFirebase @Inject constructor() : BaseFirebase(), LoginUsacase<LoginParams, AuthResult> {
    override fun buildUseCaseObservable(params: LoginParams): Observable<AuthResult> {
